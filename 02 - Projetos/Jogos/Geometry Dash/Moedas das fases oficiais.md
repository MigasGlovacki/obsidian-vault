...
> Progresso: **34/66** — marca com `[x]` conforme coleta; Monika atualiza a contagem.
...
## Can't Let Go
- [x] **Moeda 1 — 26%** (cubo) — Após o pad além dos três orbs, deslize 2 plataformas, suba 2 e caia na moeda; três pads devolvem à rota.
- [x] **Moeda 2 — 62%** (nave) — Voe por cima do primeiro obstáculo suspenso com spikes.
- [x] **Moeda 3 — 76%** (cubo) — Após o terceiro orb do segmento antigravidade, deslize de um bloco e pule limpando um spike, caindo de cabeça pra baixo na moeda; quatro pads devolvem.

## Jumper
- [ ] **Moeda 1 — 36%** (nave) — No segundo segmento antigravidade, voe pra baixo pelo vão da coluna com spikes.
- [ ] **Moeda 2 — 43%** (cubo) — Após a primeira nave, deslize, pule 2× pra uma saliência, 1× pra coluna suspensa e de novo pra moeda.
- [ ] **Moeda 3 — 68%** (nave) — Voe por baixo do décimo terceiro obstáculo com spikes, perto do chão.

## Time Machine
- [ ] **Moeda 1 — 12%** (cubo) — Após o segundo segmento antigravidade: pule os spikes até um bloco sob spike acima, pule pela borda limpando o spike e caia noutro bloco (moeda no caminho).
- [ ] **Moeda 2 — 37%** (nave) — No começo da sequência, voe pelo vão central de um obstáculo com spikes.
- [ ] **Moeda 3 — 69%** (cubo) — No segmento antigravidade após voltar à direção normal: siga o pad de volta à rota e espere passando sob spikes acima.

## Cycles
- [ ] **Moeda 1 — 42%** (bola) — Após os dois primeiros obstáculos, role pelo vão acima dos spikes, flip 1× pra moeda e role de volta.
- [ ] **Moeda 2 — 63%** (nave) — Após alternar gravidade 7×, caia pra cima na moeda antes de voar pra baixo pra desviar da parede.
- [ ] **Moeda 3 — 87%** (bola) — A chata: flip cedo pra baixo e de volta por cima do pad, fenda entre spikes, flip do teto, desliza no topo da plataforma, flip pro teto (moeda!), role o vão da plataforma estreita com spikes e flip de novo pra sair.
...
- [ ] **Moeda 2 — 71%** (UFO) — Ao virar UFO, suba pela passagem alternativa com spikes que somem: pule sobre 3 e passe sob 2.
- [ ] **Moeda 3 — 96%** (nave) — Ao virar nave, voe pra baixo pelo espaço da primeira estrutura demoníaca.

## Electrodynamix
- [ ] **Moeda 1 — 40%** (UFO) — Após encolher, passe quatro linhas de serras e suba pelo vão entre duas serras no centro, rumo ao teto.
- [ ] **Moeda 2 — 57%** (cubo) — No triângulo de orbs, bata nos dois orbs de gravidade (pulando o orb de pulo) pra cair na fenda que leva à moeda. Timing delicado.
- [ ] **Moeda 3 — 85%** (cubo) — Após o primeiro orb amarelo, pule o orb de gravidade, passe sob uma serra em plataforma escondida, pad de gravidade (moeda!), pule e orb de gravidade pra voltar.

## Hexagon Force
- [ ] **Moeda 1 — 22%** (bola) — Ao se aproximar da rampa, flip instantâneo pra moeda e bata no pad amarelo.
- [ ] **Moeda 2 — 72%** (nave) — Após sair do dual, atravesse o obstáculo perto do fundo.
- [ ] **Moeda 3 — 97%** (nave) — Após o dual acabar, voe sobre o obstáculo grande e desça no vão do próximo (moeda) — cuidado pra não ficar preso.

## Blast Processing
- [ ] **Moeda 1 — 52%** (wave) — Após entrar no dual, passe duas estruturas de diamante e entre na terceira.
- [ ] **Moeda 2 — 69%** (UFO) — Deslize e caia da primeira estrutura de rosto, pule 3× pra entrar noutra estrutura de rosto.
