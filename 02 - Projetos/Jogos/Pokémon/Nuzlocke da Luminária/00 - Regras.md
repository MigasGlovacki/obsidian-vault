...
Antes de atualizar registros importantes depois de uma sessão, a Moni deve consultar `Estado Atual/estado-atual.md` ou `Estado Atual/estado-atual.json` quando João tiver salvo o jogo e exportado o relatório do save. O estado atual é a fonte viva; não dependemos de snapshots históricos.
