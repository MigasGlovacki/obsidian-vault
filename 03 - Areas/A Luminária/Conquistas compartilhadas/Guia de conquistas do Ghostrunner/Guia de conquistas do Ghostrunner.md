...
Faça a campanha coletando tudo que encontrar, use as oportunidades abaixo para os desafios de combate, termine a história e só então faça a limpeza pelo **Seleção de Fase** — ele mostra a contagem de colecionáveis por missão. Não há dificuldade selecionável que bloqueie conquistas.
...
- [3. Coletáveis](#3-coletáveis)
  - [Artefatos — 35](#artefatos--35-por-ordem-de-aparição)
  - [Espadas — 15](#espadas--15)
  - [Áudios do Adam — 7](#áudios-do-adam--7)
  - [Project_Hel — 25 itens](#project_hel--25-itens)
...
|---|---:|---|
| Campanha principal | **~7 h 04 min** | História, aprendizado das mecânicas e colecionáveis da rota; na prática, 4–7 sessões de 60–120 min |
| Campanha + extras | **~9 h 27 min** | Boa meta para terminar a história já com a maior parte dos itens e conquistas naturais |
| 100% / Completionist | **~15 h 38 min** | Referência global para a campanha base completa; inclui a limpeza e a prática que os desafios pedem |
| Project_Hel *(quando tiver)* | **~3 h** história / **~5 h** 100% | Estimativa separada do HLTB para o DLC; não está incluída nas 15 h 38 min acima |

**Jeito saudável de dividir:** campanha em sessões de 60–120 min; limpeza por fase/objetivo; desafios finais em uma sessão separada e leve. Não tente transformar uma sequência de falhas num turno de oito horas, porque o Ghostrunner não melhora quando você está cansado — só fica mais maldoso, ahaha.

---

# 1. Troféus perdíveis

## Nenhum é permanentemente perdível

A campanha e o DLC têm **Seleção de Fase** após concluídos. Colecionáveis, desafios de combate e objetivos de fase podem ser refeitos; portanto, não é necessário iniciar um save novo.

Ainda assim, há conquistas **sensíveis à situação**. Vale tentar quando a fase/arena está fresca, para evitar voltar só por uma delas:
...
- [ ] **#15** — arena de três inimigos, dois com escudo: junto ao inimigo de trás e ao escudo azul, suba nas caixas à esquerda.
- [ ] **#16** — plataforma com feixe vermelho: veja o item abaixo/esquerda; corra pela parede direita além da proteção, pule sobre o feixe usando Reforço Sensorial e alcance a saliência.
- [ ] **#17** — use a cerca quebrada e inclinada à esquerda: wall-run, salte com Reforço Sensorial para a direita, siga a parede até a fenda escondida.

### Run-up
- [ ] **#18** — depois de matar os seis inimigos da abertura, no último patamar vire-se e olhe a pequena alcova à esquerda, atrás da superfície laranja; dê dash até ela.

### Dharma City
- [ ] **#19** — Uplink que aumenta o salto: suba na plataforma alta à frente e, antes de seguir para o próximo boost, vire à direita (não à esquerda) e pegue o item.
- [ ] **#20** — na plataforma seguinte, o item está atrás da cerca de arame; contorne pela esquerda e use wall-run.
- [ ] **#21** — estação de trem: suba a escada esquerda e saia para a cidade. Use o gancho para ir ao trilho da direita, siga até o fim e entre pela pequena porta sob a cobertura azul à esquerda.
- [ ] **#22** — após o boost e os três Drones, hackeie o painel durante o wall-run; hackeie-o de novo para abrir o caminho à esquerda para a plataforma do item.

### Echoes
- [ ] **#23** — depois do item no cano, suba de tirolesa; o artefato fica acima. Wall-run pela parede direita à saliência distante, vire e corra de volta pela parede para alcançar o alto.
- [ ] **#24** — no segundo sniper e parede hackeável: olhe à esquerda, atrás das caixas; hackeie a cobertura e avance pela esquerda sem entrar na linha de tiro.
- [ ] **#25** — ao pegar o boost de salto, não avance: caia, vire à direita e pule à saliência projetada. Depois volte, recupere o boost e prossiga.

### Faster
- [ ] **#26** — pouco antes do primeiro gancho, atravesse a porta destrancada; está imediatamente à esquerda.

### The Forbidden Zone
- [ ] **#27** — após deslizar para a sala com inimigo à frente e outro à esquerda, mate o terceiro na esquina; wall-run na parede frontal para a direita e depois na superfície esquerda até a plataforma do item.
- [ ] **#28** — após destruir três torretas com feixes sobrepostos, procure o grafite **“don’t be fooled”** à direita. Corra até a parede, olhe para cima/atrás e use o gancho para ser lançado ao item.
- [ ] **#29** — depois do trilho ascendente e dois inimigos que saltam, vá à direita e caia antes de continuar.

### Reign in Hell
- [ ] **#30** — quando criaturas caem na plataforma à frente, caminhe até a proteção, vire, ande para trás e caia; dê dash para frente no ar para pegar o item visível.
- [ ] **#31** — sala do billboard vermelho e parede elétrica esquerda: antes de avançar, vire e corra de volta pelo billboard vermelho até a saliência.
- [ ] **#32** — logo após o trilho amarelo e as criaturas, está à direita.

### Things You Wouldn’t Believe
- [ ] **#33** — começo, trilho amarelo com dois Drones: vire-se antes de seguir e pegue o trilho para a plataforma acima da porta.
- [ ] **#34** — no trilho que o jogo indica seguir à esquerda, vire e pegue-o à direita; suba as plataformas até o topo da estrutura metálica.
- [ ] **#35** — no segundo boost de salto para uma estrutura metálica: suba à primeira saliência, vá à direita para outro boost e use-o para alcançar o topo.
...
- [ ] **#8 — Dharma City:** pegue a tirolesa que curva à direita; ela termina numa alcova com a espada.
- [ ] **#9 — Echoes:** vire à esquerda e verá a espada distante à direita; atravesse as paredes em wall-run, volte pela parede até a rampa e deslize para retomar a rota.
- [ ] **#10 — Echoes:** após a primeira luta contra uma Máquina, retorne à rampa por onde veio; há uma abertura acima da posição dela. Wall-run na parede esquerda, salte à direita para a saliência.
- [ ] **#11 — In Her Own Image:** automática ao concluir a fase.
- [ ] **#12 — The Forbidden Zone:** após deslizar para a luta contra duas Máquinas, entre por baixo da porta de persiana semiaberta à esquerda; item atrás das caixas.
- [ ] **#13 — Reign in Hell:** início: siga a criatura, vire à direita e destrua a caixa elétrica para abrir a porta.
- [ ] **#14 — Reign in Hell:** após os dois primeiros encontros externos, vá ao billboard direito, pegue o trilho amarelo à esquerda e, ao aterrissar, vire-se imediatamente e deslize de volta pelo corrimão.
- [ ] **#15 — Things You Wouldn’t Believe:** seção de trilhos amarelos, paredes e tanques; antes do Divisor, está no tanque da esquerda.

## Áudios do Adam — 7

- [ ] **#1 — The Climb:** sala das plataformas quebradas e canos. Chegue ao fim da ponte, olhe para baixo e caia na ponte quebrada; vá **à direita**, wall-run até os canos e siga-os até o ponto de interrogação luminoso.
- [ ] **#2 — Breathe In:** primeira sequência de ventoinhas sobre um vão; entre na primeira ventoinha de costas e olhe para cima.
- [ ] **#3 — Run-up:** depois do deslize entre trituradores, assim que atravessar a porta, vire para ela e olhe para cima: gancho para o áudio.
- [ ] **#4 — Echoes:** após subir pelo trilho amarelo até dois inimigos e uma Máquina, há outro inimigo/Máquina à esquerda; o áudio está no cano acima. Suba pelo próximo trilho, vire e corra pelo cano quebrado grande.
- [ ] **#5 — The Forbidden Zone:** começo, sala da primeira torreta; no alto à direita, sobre caixas grandes.
- [ ] **#6 — Reign in Hell:** no billboard com fio amarelo pendurado, siga à direita pela estrutura metálica.
- [ ] **#7 — Things You Wouldn’t Believe:** sala das paredes elétricas e tanques; ao cair para pegar o boost de salto, use-o para ir à **esquerda** e subir no outro tanque.
...
1. **Colete na primeira passagem, mas não transforme a campanha num vídeo-aula.** Abra este guia ao entrar em uma fase com itens; pegue os da fase e volte a jogar. Deixar muitos para a limpeza pode obrigar a refazer os trechos longos finais só por uma caixa escondida.
2. **A seleção de fase é sua amiga.** Ela registra quantos colecionáveis foram achados por missão. Primeiro corrija a contagem; só então use vídeo/screenshot para o item específico.
3. **Morte é informação.** Em vez de repetir uma sala do mesmo jeito dez vezes, mude uma variável: rota, ordem de alvo, habilidade ou timing do dash. O jogo recompensa leitura, não teimosia mecânica.
...
- **Steam MCP (perfil de João):** lista de conquistas, nomes em PT-BR e estado atual — AppID 1139900.
- [PSNProfiles — Ghostrunner Trophy Guide](https://psnprofiles.com/guide/11898-ghostrunner-trophy-guide) — roadmap, rotas de limpeza e estratégias de combate.
- [Steam Community — Achievement Guide](https://steamcommunity.com/sharedfiles/filedetails/?id=2273469880) — referência comunitária geral.
- [Steam Community — Artifacts / Audiologs / Swords](https://steamcommunity.com/sharedfiles/filedetails/?id=2269451048) — referência comunitária de colecionáveis.
- [Steam Community — Project Hel Achievements](https://steamcommunity.com/sharedfiles/filedetails/?id=2774413800) e [guia dos colecionáveis de Hel](https://steamcommunity.com/sharedfiles/filedetails/?id=2772976971).
